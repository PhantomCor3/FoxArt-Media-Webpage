                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="xs-lsit list-inline">
                                ...
                                <li><img src="images/partner/partner-1.png" alt=""></li>
                                <li><img src="images/partner/partner-2.png" alt=""></li>
                                <li><img src="images/partner/partner-3.png" alt=""></li>
                                <li><img src="images/partner/partner-4.png" alt=""></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <ul class="xs-list list-inline text-right">
                                <li><img src="images/card/visa.png" alt=""></li>
                                <li><img src="images/card/master-card.png" alt=""></li>
                                <li><img src="images/card/discover.png" alt=""></li>
                                <li><img src="images/card/american-express.png" alt=""></li>
                            </ul>
                        </div>
                    </div>
                </div>
