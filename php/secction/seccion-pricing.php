                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="xs-single-pricing">
                                    <div class="pricing-header">
                                        <h3 class="xs-content-title">Basic Business Project</h3>
                                        <div class="pricing-img-block">
                                            <img src="images/pricing/pricing-1.png" alt="hostinza pricing image">
                                        </div>
                                        <h2 class="price-table">Includes <sub>/6mo</sub></h2>
                                    </div>
                                    <!-- .pricing-header END -->
                                    <div class="pricing-body">
                                        <ul class="xs-list">
                                            <li>Business Branding </li>
                                            <li>Online Customized Website</li>
                                            <li>Domain and hosting</li>
                                            <li>1 Free Changes<sub> /m</sub></li>
                                            <li>24/7 support</li>
                                        </ul>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="xs-single-pricing active">
                                    <div class="pricing-header">
                                        <h3 class="xs-content-title">Superior Business Project</h3>
                                        <div class="pricing-img-block">
                                            <img src="images/pricing/pricing-2.png" alt="hostinza pricing image">
                                        </div>
                                        <h2 class="price-table">Includes <sub>/1yr</sub></h2>
                                    </div>
                                    <!-- .pricing-header END -->
                                    <div class="pricing-body">
                                        <ul class="xs-list">
                                            ...
                                            <li>Domain and hosting</li>
                                            <li>Basic SEO</li>
                                            <li>Facebook Business Creation</li>
                                            <li>Local Directories Registration</li>
                                            <li>4 Free Changes<sub> /m</sub></li>
                                            <li>24/7 support</li>
                                        </ul>
                                    </div>
                                    <!-- .pricing-body END -->
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="xs-single-pricing">
                                    <div class="pricing-header">
                                        <h3 class="xs-content-title">VIP Business Project</h3>
                                        <div class="pricing-img-block">
                                            <img src="images/pricing/pricing-3.png" alt="hostinza pricing image">
                                        </div>
                                        <h2 class="price-table">Includes <sub>/∞</sub></h2>
                                    </div>
                                    <!-- .pricing-header END -->
                                    <div class="pricing-body">
                                        <ul class="xs-list">
