            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs main-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="tab-three-area" data-toggle="tab" href="#tab-three" role="tab" aria-controls="tab-three" aria-selected="false"><span class="icon-holder"><img src="images/service-tab/icon-3.png" alt=""></span> Pay Per Click</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-four-area" data-toggle="tab" href="#tab-four" role="tab" aria-controls="tab-four" aria-selected="false"><span class="icon-holder"><img src="images/service-tab/icon-4.png" alt=""></span> Email Marketing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-five-area" data-toggle="tab" href="#tab-five" role="tab" aria-controls="tab-five" aria-selected="false"><span class="icon-holder"><img src="images/service-tab/icon-5.png" alt=""></span> Social Marketing</a>
                        </li>
                    </ul>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="service-preview-img">
                                            <img src="images/service-tab/preview-1.png" alt="">
                                        </div>
                                        <!-- .service-preview-img END -->
                                    </div>
                                    <div class="col-lg-7 col-md-6">
                                        ...
                                        <!-- .service-preview-content END -->
                                    </div>
                                </div>
                                <!-- .row END -->
                            </div>
                            <!-- .single-service-preview END -->
                        </div>
                        <!-- #tab-one END -->
                        ...
                        <div class="tab-pane fadeInRight animated" id="tab-two" role="tabpanel" aria-labelledby="tab-two-area">
                            <div class="single-service-preview">
                                <div class="row">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="service-preview-img">
                                            <img src="images/service-tab/preview-2.png" alt="">
                                        </div>
                                        <!-- .service-preview-img END -->
                                    </div>
                                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="tab-pane fadeInRight animated" id="tab-three" role="tabpanel" aria-labelledby="tab-three-area">
                            <div class="single-service-preview">
                                <div class="row">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="service-preview-img">
                                            <img src="images/service-tab/preview-3.png" alt="">
                                        </div>
                                        <!-- .service-preview-img END -->
                                    </div>
                                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="tab-pane fadeInRight animated" id="tab-four" role="tabpanel" aria-labelledby="tab-four-area">
                            <div class="single-service-preview">
                                <div class="row">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="service-preview-img">
                                            <img src="images/service-tab/preview-4.png" alt="">
                                        </div>
                                        <!-- .service-preview-img END -->
                                    </div>
                                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="tab-pane fadeInRight animated" id="tab-five" role="tabpanel" aria-labelledby="tab-five-area">
                            <div class="single-service-preview">
                                <div class="row">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="service-preview-img">
                                            <img src="images/service-tab/preview-5.png" alt="">
                                        </div>
                                        <!-- .service-preview-img END -->
                                    </div>
                                    <div class="col-lg-7 col-md-6">
